package com.yarten.circlepicker;
...
import com.yarten.circlepicker.formatter.SimpleValueFormatter;
import com.yarten.circlepicker.formatter.ValueFormatter;
...
public class CirclePickerView extends View {
    ...
    private class CirclePickerRenderer {
        ...
        public void draw(Canvas canvas) {
            ...
            float colorSweepAngle = (float) mAngleHelper.getAngle();

            if(colorSweepAngle >= 360)
                colorSweepAngle = 360;
            else
            {
                colorSweepAngle = (colorSweepAngle + 360) % 360;
            }
